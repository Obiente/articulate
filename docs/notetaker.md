...
Choose **New note** and start typing in **My notes**. You do not need a microphone, a speech model, or a recording. The title is editable. Changes save after a short pause, when you leave the note, and when Articulate closes.
...
Choose **Record a conversation** to open audio setup and capture controls. During a capture, use **My notes** to write while the transcript continues. **Highlights** holds reviewed excerpts from the transcript; **Transcript** shows the conversation. These are separate from your own writing.
